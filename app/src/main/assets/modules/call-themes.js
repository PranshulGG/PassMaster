    ...
    if (currentTheme === 'dark') {
        ...
        if (currentColorTheme === 'Material You (Berry pop blue 44)') {
          ...
          sendThemeToAndroid('Activityreddark');
            ...
            sendThemeToAndroid('ActivityBlueBrightdark');
        }
        ...
        if (currentColorTheme === 'Material You (Berry pop blue 44)') {
            ...
            sendThemeToAndroid('ActivityBlueBrightLight');
        }
...
function sendThemeToAndroid(theme) {
    ...
    function dialogcolorActivity(){
        ...
        if (currentTheme === 'dark') {
            ...
            if (currentColorTheme === 'Material You (Berry pop blue 44)') {
                sendThemeToAndroid('dialogflip-blue-dark');
            } else if (currentColorTheme === 'Material You (Raisin purple 100)') {
                sendThemeToAndroid('dialogflip-purple-dark');
            } else if (currentColorTheme === 'Material You (Olive pop green 49)') {
                sendThemeToAndroid('dialogflip-yellow-dark');
    
            } else if (currentColorTheme === 'Material You (Forest green 33)') {
                sendThemeToAndroid('dialogflip-green-dark');
    
            } else if (currentColorTheme === 'Material You (Chestnut cool red 122)') {
              sendThemeToAndroid('dialogflip-red-dark');
            } else if (currentColorTheme === 'Material You (Raspberry pink P99)') {
                sendThemeToAndroid('dialogflip-pink-dark');
              } else if (currentColorTheme === 'Material You (Deep charcoal 83)'){
                sendThemeToAndroid('dialogflip-charcoal-dark');
    
              } else if (currentColorTheme === 'Material You (Hint orange 33)'){
                sendThemeToAndroid('dialogflip-orange-dark');
            } else if (currentColorTheme === 'Material You (Blue bright P40)') {
                sendThemeToAndroid('dialogflip-blue-dark');
            ...
            if (currentColorTheme === 'Material You (Berry pop blue 44)') {
                sendThemeToAndroid('dialogflip-blue-light');
            } else if (currentColorTheme === 'Material You (Raisin purple 100)') {
                sendThemeToAndroid('dialogflip-purple-light');
            } else if (currentColorTheme === 'Material You (Olive pop green 49)') {
                sendThemeToAndroid('dialogflip-yellow-light');
    
            } else if (currentColorTheme === 'Material You (Forest green 33)') {
                sendThemeToAndroid('dialogflip-green-light');
    
            } else if (currentColorTheme === 'Material You (Chestnut cool red 122)') {
              sendThemeToAndroid('dialogflip-red-light');
            } else if (currentColorTheme === 'Material You (Raspberry pink P99)') {
                sendThemeToAndroid('dialogflip-pink-light');
              } else if (currentColorTheme === 'Material You (Deep charcoal 83)'){
                sendThemeToAndroid('dialogflip-charcoal-light');
    
              } else if (currentColorTheme === 'Material You (Hint orange 33)'){
                sendThemeToAndroid('dialogflip-orange-light');
